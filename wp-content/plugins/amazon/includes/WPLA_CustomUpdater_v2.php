...
class WPLA_Update_API {
	...
	public static function license_inactive_notice() { 
		...
		<div id="message" class="error">
			<p><?php printf( __( 'The plugin license key has not been activated, so you won\'t be able to get updates! %sClick here%s to activate the license key and the plugin.', 'wpla' ), '<a href="' . esc_url( admin_url( 'admin.php?page=wpla-settings&tab=license' ) ) . '">', '</a>' ); ?></p>
		</div>
		<?php
	}
