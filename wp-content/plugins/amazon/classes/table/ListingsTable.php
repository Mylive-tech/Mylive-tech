...
class WPLA_ListingsTable extends WP_List_Table {
    ...
    function get_views(){
        ...
        $class = ($current == 'online' ? ' class="current"' :'');
        ...
        $class = ($current == 'matched' ? ' class="current"' :'');
        ...
        if ( isset($summary->failed) ) {
           ...
           $class = ($current == 'failed' ? ' class="current"' :'style="color:darkred"');
        ...
        // FBA
        $is_fba_url = add_query_arg( 'listing_status', 'is_fba', $base_url );
        $class = ($current == 'is_fba' ? ' class="current"' :'');
        $views['is_fba'] = "<a href='{$is_fba_url}' {$class} >".__('FBA','wpla')."</a>";

        // Non-FBA
        $is_not_fba_url = add_query_arg( 'listing_status', 'is_not_fba', $base_url );
