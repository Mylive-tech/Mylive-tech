...
class WPLA_ReportsTable extends WP_List_Table {
    ...
    function get_bulk_actions() {
        $actions = array(
            'update' 	=> __('Update selected reports from Amazon','wpla'),
            'delete'    => __('Delete selected reports','wpla')
        );
        return $actions;
    }
    ...
    function get_views(){
       ...
       $base_url = remove_query_arg( array( 'action', 'report', 'report_status' ) );
       ...
       if ( isset($summary->unknown) ) {
           $unknown_url = add_query_arg('report_status','unknown');
