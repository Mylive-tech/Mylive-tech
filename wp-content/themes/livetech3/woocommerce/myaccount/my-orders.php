...
if ( $customer_orders ) : ?>
	...
	<p><?php printf( __( 'You have not ordered anything yet. Subscribe to our products & services %sstore%s.', WC_Subscriptions::$text_domain ), '<a href="' . get_permalink( woocommerce_get_page_id( 'shop' ) ) . '">', '</a>' ); ?></p>
