					...
					<div id="logo" class="logo-left">
						<a href="<?php echo esc_url( home_url( '/' ) ); ?>" title="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?> - <?php bloginfo( 'description' ); ?>" rel="home">
							<?php if($flatsome_opt['site_logo']){
								...
								$imgMeta = getimagesize($flatsome_opt['site_logo']);
								echo '<img src="'.$flatsome_opt['site_logo'].'" class="header_logo '.$logo_class.'" alt="'.$site_title.'" width="'.$imgMeta[0].'" height="'.$imgMeta[1].'"/>';
...
<div id="top-bar1">
			<div class="row">
				<div class="large-12 columns">
					<!-- left text -->
					<div class="left-text left">
						<div class="html">&nbsp</div>
					</div>
					<!-- top bar right -->
					<div class="right-text right">
<br>
						<div style="margin-right: 87%; width: 71%;"> <div class="row collapse search-wrapper"> 	<form role="search" action="https://www.mylive-tech.com/" class="searchform" id="searchform" method="get">    		<div class="large-10 small-10 columns"> 	   		<input type="search" placeholder="Search…" id="s" value="" name="s" class="field"> 	   		                <input type="hidden" value="product" name="post_type">           	  	  </div><!-- input --> 	  <div class="large-2 small-2 columns"> 	    <button class="button secondary postfix"><i class="icon-search"></i></button> 	  </div><!-- button --> 	  </form> </div> </div>
					</div><!-- top bar right -->
