...
class WC_Pos_Receipts {
  ...
  public function get_data_names(){
	...
	{
		$elems = 'body.pos_receipt, table.order-info, table.receipt_items, #pos_receipt_title, #pos_receipt_address, #pos_receipt_contact, #pos_receipt_header, #pos_receipt_footer, #pos_receipt_tax, #pos_receipt_info, #pos_receipt_items';
		$templates = array(
			'text_size'                    => array(
