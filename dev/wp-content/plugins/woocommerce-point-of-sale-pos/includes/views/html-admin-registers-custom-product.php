<div class="overlay_order_popup" id="add_custom_product_overlay_popup">
    <div id="add_custom_product_popup">
        <div class="media-frame-title">
            <h1><?php _e('Custom Product', 'wc_point_of_sale'); ?></h1>
            <div class="clear"></div>
        ...
        <div class="media-frame-footer">
            <button class="button" id="add_custom_product_meta"><?php _e('Add Meta', 'wc_point_of_sale'); ?></button>
            <button class="button button-primary" id="add_custom_product"><?php _e('Add Product', 'wc_point_of_sale'); ?></button>
        </div>
    </div>
</div>