...
<table class="form-table">
		...
		<tr valign="top">
			...
			<td><input type="text" class="widefat" value="<?php echo esc_attr($this->post_data['subject']); ?>" name="mymail_data[subject]" id="mymail_subject"></td>
		</tr>
		<tr valign="top">
			<th scope="row"><?php _e('Preheader', 'mymail') ?></th>
			<td><input type="text" class="widefat" value="<?php echo esc_attr($this->post_data['preheader']); ?>" name="mymail_data[preheader]" id="mymail_preheader"></td>
		</tr>
		<tr valign="top">
			...
			<td><input type="text" class="widefat" value="<?php echo esc_attr($this->post_data['from_name']); ?>" name="mymail_data[from_name]" id="mymail_from-name"></td>
		</tr>
		<tr valign="top">
			...
			<td><input type="text" class="widefat" value="<?php echo esc_attr($this->post_data['from_email']); ?>" name="mymail_data[from_email]" id="mymail_from"></td>
		</tr>
		<tr valign="top">
			...
			<td><input type="text" class="widefat" value="<?php echo esc_attr($this->post_data['reply_to']); ?>" name="mymail_data[reply_to]" id="mymail_reply_to"></td>
		</tr>
	 </tbody>
</table>
