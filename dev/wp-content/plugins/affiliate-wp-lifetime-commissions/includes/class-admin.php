	...
	*/
	public function settings_integrations( $settings = array() ) {
		...
		$settings[ 'lifetime_commissions' ] = array(
			'name' => __( 'Lifetime Commissions:</br> Enable For All Affiliates?', 'affiliate-wp-lifetime-commissions' ),
	...
	*/
	public function settings_misc( $settings = array() ) {
		...
		$settings[ 'lifetime_commissions_uninstall_on_delete' ] = array(
			'name' => __( 'Lifetime Commissions:<br/> Remove Data on Uninstall?', 'affiliate-wp-lifetime-commissions' ),
