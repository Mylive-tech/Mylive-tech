		...
		function add_mce_popup(){
		    ...
		    <script>
			    function WPSEO_InsertMap() {
			        ...
			        var show_url = jQuery("#wpseo_map_show_email").is(":checked") ? ' show_email="1"' : '';
			        ...
			        window.send_to_editor("[wpseo_map " + id + term + " width=\"" + width + "\" height=\"" + height + "\" zoom=\"" + zoom + "\" map_style=\"" + map_style + "\"" + scrollable + show_route + show_state + show_country + show_url + "]");
			    }
		        function WPSEO_InsertAddress() {
		            ...
		            window.send_to_editor("[" + shortcode_name + " " + id + term + hide_name + oneline + show_state + show_country + show_phone +show_phone_2 + show_fax + show_email + show_url + show_opening_hours + hide_closed + orderby + order + "]");
		        }
