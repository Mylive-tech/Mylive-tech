...
class FPRacCouponDelete {
    ...
    function delete_expired_rac_coupon() {
    ...
    function delete_rac_coupon($order_id) {
...
add_action('woocommerce_checkout_order_processed', array($rac_coupon_delete, 'delete_rac_coupon'), 10, 1);
add_action('rac_cron_job', array($rac_coupon_delete, 'delete_expired_rac_coupon'));
?>