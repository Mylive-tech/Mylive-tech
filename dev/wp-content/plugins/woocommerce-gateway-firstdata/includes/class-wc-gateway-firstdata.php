...
class WC_Gateway_FirstData extends WC_Payment_Gateway {
	...
	public function __construct() {
		...
		$this->method_title       = __( 'First Data Payeezy', WC_FirstData::TEXT_DOMAIN );
		$this->method_description = __( '(Formely First Data GGe4) Allow customers to securely save their credit card to their account for use with single purchases, pre-orders, and subscriptions.', WC_FirstData::TEXT_DOMAIN );
		...
		// pay page fallback
		add_action( 'woocommerce_receipt_' . $this->id, create_function( '$order', 'echo "<p>" . __( "Thank you for your order.", WC_FirstData::TEXT_DOMAIN ) . "</p>";' ) );
	...
	public function init_form_fields() {
		...
		$this->form_fields = array(
			...
			'enabled' => array(
				'title'   => __( 'Enable / Disable', WC_FirstData::TEXT_DOMAIN ),
				'label'   => __( 'Enable this gateway', WC_FirstData::TEXT_DOMAIN ),
				'type'    => 'checkbox',
				'default' => 'no',
			),

			'title' => array(
				'title'    => __( 'Title', WC_FirstData::TEXT_DOMAIN ),
				'type'     => 'text',
				'desc_tip' => __( 'Payment method title that the customer will see during checkout.', WC_FirstData::TEXT_DOMAIN ),
				'default'  => 'Credit Card',
			),

			'description' => array(
				'title'    => __( 'Description', WC_FirstData::TEXT_DOMAIN ),
				'type'     => 'textarea',
				'desc_tip' => __( 'Payment method description that the customer will see during checkout.', WC_FirstData::TEXT_DOMAIN ),
				'default'  => __( 'Pay securely using your credit card.', WC_FirstData::TEXT_DOMAIN ),
			),

			'card_types' => array(
				'title'    => __( 'Accepted Card Logos', WC_FirstData::TEXT_DOMAIN ),
				'type'     => 'multiselect',
				'desc_tip' => __( 'Select which card types you accept to display the logos for on your checkout page.  This is purely cosmetic and optional, and will have no impact on the cards actually accepted by your account.', WC_FirstData::TEXT_DOMAIN ),
			...
			'environment' => array(
				'title'    => __( 'Environment', WC_FirstData::TEXT_DOMAIN ),
				'type'     => 'select',
				'default'  => 'production',
				'desc_tip' => __( 'The production environment should be used unless you have a separate demo account.', WC_FirstData::TEXT_DOMAIN ),
				'options'  => array(
					'production' => __( 'Production', WC_FirstData::TEXT_DOMAIN ),
					'demo'       => __( 'Demo', WC_FirstData::TEXT_DOMAIN ),
				),
			),

			'gateway_id' => array(
				'title'    => __( 'Gateway ID', WC_FirstData::TEXT_DOMAIN ),
				'type'     => 'text',
				'class'    => 'production-field',
				'desc_tip' => __( 'Your unique Gateway ID, note this is not the same as your account user name.', WC_FirstData::TEXT_DOMAIN ),
			),

			'gateway_password' => array(
				'title'    => __( 'Gateway Password', WC_FirstData::TEXT_DOMAIN ),
				'type'     => 'password',
				'class'    => 'production-field',
				'desc_tip' => __( 'Your private gateway password, note this is not the same as your account user password.', WC_FirstData::TEXT_DOMAIN ),
			),

			'key_id' => array(
				'title'    => __( 'Key id', WC_FirstData::TEXT_DOMAIN ),
				'type'     => 'text',
				'class'    => 'production-field',
				'desc_tip' => __( 'Your terminal API Access Key id.', WC_FirstData::TEXT_DOMAIN ),
			),

			'hmac_key' => array(
				'title'    => __( 'Hmac Key', WC_FirstData::TEXT_DOMAIN ),
				'type'     => 'password',
				'class'    => 'production-field',
				'desc_tip' => __( 'Your terminal API secret Hmac key.', WC_FirstData::TEXT_DOMAIN ),
			),
			...
			'demo_gateway_id' => array(
				...
				'type'     => 'text',
				'class'    => 'demo-field',
				'desc_tip' => __( 'Your unique Gateway ID, note this is not the same as your account user name and will be in the format of Axxxxx-xx.', WC_FirstData::TEXT_DOMAIN ),
			),
			...
			'transaction_type' => array(
				'title'    => __( 'Transaction Type', WC_FirstData::TEXT_DOMAIN ),
				'type'     => 'select',
				'desc_tip' => __( 'Select how transactions should be processed. Purchase submits all transactions for settlement, Pre-Authorization simply authorizes the order total for capture later.', WC_FirstData::TEXT_DOMAIN ),
				'default'  => self::TRANSACTION_TYPE_CHARGE,
				'options'  => array(
					self::TRANSACTION_TYPE_CHARGE        => __( 'Purchase', WC_FirstData::TEXT_DOMAIN ),
					self::TRANSACTION_TYPE_AUTHORIZATION => __( 'Pre-Authorization', WC_FirstData::TEXT_DOMAIN ),
				),
			),

			'partial_redemption' => array(
				'title'    => __( 'Partial Redemption', WC_FirstData::TEXT_DOMAIN ),
				'label'    => __( 'Enable Partial Redemption', WC_FirstData::TEXT_DOMAIN ),
				'type'     => 'checkbox',
				'desc_tip' => __( 'A partial redemption will be returned if only a portion of the requested funds are available. For example, if a transaction is submitted for $100, but only $80 is available on the customer\'s card, the $80 will be authorized or captured when this property is set to true. This property can be used for all types of pre-authorization and purchase transactions.',  WC_FirstData::TEXT_DOMAIN ),
				'default'  => 'no',
			),

			'tokenization' => array(
				'title'       => __( 'Tokenization', WC_FirstData::TEXT_DOMAIN ),
				'label'       => __( 'Allow customers to securely save their credit card details for future checkout.', WC_FirstData::TEXT_DOMAIN ),
				'type'        => 'checkbox',
			...
			'soft_descriptors_enabled' => array(
				'title'       => __( 'Soft Descriptors', WC_FirstData::TEXT_DOMAIN ),
				'label'       => __( 'Enable soft descriptors', WC_FirstData::TEXT_DOMAIN ),
				'type'        => 'checkbox',
			...
			'soft_descriptor_dba_name' => array(
				'title'    => __( 'DBA Name', WC_FirstData::TEXT_DOMAIN ),
				'desc_tip' => __( 'Business name.', WC_FirstData::TEXT_DOMAIN ),
				'class'    => 'soft-descriptor',
				'type'     => 'text',
			),

			'soft_descriptor_street' => array(
				'title'    => __( 'Street', WC_FirstData::TEXT_DOMAIN ),
				'desc_tip' => __( 'Business address.', WC_FirstData::TEXT_DOMAIN ),
				'class'    => 'soft-descriptor',
				'type'     => 'text',
			),

			'soft_descriptor_city' => array(
				'title'    => __( 'City', WC_FirstData::TEXT_DOMAIN ),
				'desc_tip' => __( 'Business city.', WC_FirstData::TEXT_DOMAIN ),
				'class'    => 'soft-descriptor',
				'type'     => 'text',
			),

			'soft_descriptor_region' => array(
				'title'    => __( 'Region', WC_FirstData::TEXT_DOMAIN ),
				'desc_tip' => __( 'Business region.', WC_FirstData::TEXT_DOMAIN ),
				'class'    => 'soft-descriptor',
				'type'     => 'text',
			),

			'soft_descriptor_postal_code' => array(
				'title'    => __( 'Postal Code', WC_FirstData::TEXT_DOMAIN ),
				'desc_tip' => __( 'Business postal/zip code.', WC_FirstData::TEXT_DOMAIN ),
				'class'    => 'soft-descriptor',
				'type'     => 'text',
			),

			'soft_descriptor_country_code' => array(
				'title'    => __( 'Country Code', WC_FirstData::TEXT_DOMAIN ),
				'desc_tip' => __( 'Business country.', WC_FirstData::TEXT_DOMAIN ),
				'class'    => 'soft-descriptor',
				'type'     => 'text',
			),

			'soft_descriptor_mid' => array(
				'title'    => __( 'MID', WC_FirstData::TEXT_DOMAIN ),
				'desc_tip' => __( 'Merchant ID.', WC_FirstData::TEXT_DOMAIN ),
				'class'    => 'soft-descriptor',
				'type'     => 'text',
			),

			'soft_descriptor_mcc' => array(
				'title'    => __( 'MCC', WC_FirstData::TEXT_DOMAIN ),
				'desc_tip' => __( 'Your Merchant Category Code.', WC_FirstData::TEXT_DOMAIN ),
				'class'    => 'soft-descriptor',
				'type'     => 'text',
			),

			'soft_descriptor_merchant_contact_info' => array(
				'title'    => __( 'Merchant Contact Info', WC_FirstData::TEXT_DOMAIN ),
				'desc_tip' => __( 'Merchant contact information.', WC_FirstData::TEXT_DOMAIN ),
				'class'    => 'soft-descriptor',
				'type'     => 'text',
			),

			'debug_mode' => array(
				'title'    => __( 'Debug Mode', WC_FirstData::TEXT_DOMAIN ),
				'type'     => 'select',
				'desc_tip' => __( 'Show Detailed Error Messages and API requests / responses on the checkout page and/or save them to the log for debugging purposes.', WC_FirstData::TEXT_DOMAIN ),
				'default'  => 'off',
				'options'  => array(
					'off'      => __( 'Off', WC_FirstData::TEXT_DOMAIN ),
					'checkout' => __( 'Show on Checkout Page', WC_FirstData::TEXT_DOMAIN ),
					'log'      => __( 'Save to Log', WC_FirstData::TEXT_DOMAIN ),
					'both'     => __( 'Both', WC_FirstData::TEXT_DOMAIN )
				),
			),
		);
	}
	...
	public function validate_fields() {
		...
		if ( $this->get_post( 'firstdata-token' ) ) {
			...
			if ( ! $this->get_credit_card_token_details( get_current_user_id(), $this->get_post( 'firstdata-token' ) ) ) {
				SV_WC_Helper::wc_add_notice( __( 'Payment error, please try another payment method or contact us to complete your transaction.', WC_FirstData::TEXT_DOMAIN ), 'error' );
				$is_valid = false;
			}
		...
		// check security code
		if ( empty( $cvv ) ) {
			SV_WC_Helper::wc_add_notice( __( 'Card security code is missing', WC_FirstData::TEXT_DOMAIN ), 'error' );
			$is_valid = false;
		}

		// digit check
		if ( ! ctype_digit( $cvv ) ) {
			SV_WC_Helper::wc_add_notice( __( 'Card security code is invalid (only digits are allowed)', WC_FirstData::TEXT_DOMAIN ), 'error' );
			$is_valid = false;
		}

		// length check
		if ( strlen( $cvv ) < 3 || strlen( $cvv ) > 4 ) {
			SV_WC_Helper::wc_add_notice( __( 'Card security code is invalid (must be 3 or 4 digits)', WC_FirstData::TEXT_DOMAIN ), 'error' );
			$is_valid = false;
		}
		...
		if ( ! ctype_digit( $expiration_month ) || ! ctype_digit( $expiration_year ) ||
			...
			SV_WC_Helper::wc_add_notice( __( 'Card expiration date is invalid', WC_FirstData::TEXT_DOMAIN ), 'error' );
			$is_valid = false;
		}
		...
		if ( empty( $card_number ) || ! ctype_digit( $card_number ) || ! $this->luhn_check( $card_number ) ) {
			SV_WC_Helper::wc_add_notice( __( 'Card number is invalid', WC_FirstData::TEXT_DOMAIN ), 'error' );
			$is_valid = false;
		}
	...
	public function process_refund( $order_id, $amount = null, $reason = '' ) {
		...
		if ( ! $order->refund->transaction_tag || ! $order->refund->authorization_num ) {
			return new WP_Error( 'wc_first_data_refund_error', __( 'First Data Transaction Tag or Authorization Number missing, cannot refund transaction.', WC_FirstData::TEXT_DOMAIN ) );
		}
		...
		try {
			...
			if ( $response->transaction_approved() ) {
				...
				// add order note
				$order->add_order_note( sprintf( __( 'First Data Refund in the amount of %s approved.', WC_FirstData::TEXT_DOMAIN ), wc_price( $amount, array( 'currency' => $order->get_order_currency() ) ) ) );

				// For WC 2.2, if the full amount has been refunded, update the order status
				if ( SV_WC_Plugin_Compatibility::is_wc_version_lt_2_3() && $order->get_total() == $order->get_total_refunded() ) {

					$order->update_status( 'refunded', __( 'Order completely refunded.', WC_FirstData::TEXT_DOMAIN ) );
				}
				...
				$order->add_order_note( sprintf( __( 'First Data Refund failed: %s', WC_FirstData::TEXT_DOMAIN ), $response->get_failure_message() ) );
	...
	protected function create_payment_token( $order ) {
		...
		if ( $response->transaction_approved() ) {
			...
			$message = sprintf( __( 'First Data Zero Dollar Pre-Authorization Approved: %s ending in %s (expires %s).', WC_FirstData::TEXT_DOMAIN ), $response->get_card_type(), $card_last_four, $card_exp_date );
			...
			if ( $response->get_transarmor_token() ) {
				...
				$message .= __( '  Expected token not returned for transaction, verify Transarmor Token is properly configured in your First Data account.', WC_FirstData::TEXT_DOMAIN );
			}
		...
		if ( $response->transaction_approved() ) {
			...
			if ( $this->get_post( 'firstdata-tokenize-card' ) && ( ! isset( $order->payment->token ) || ! $order->payment->token ) ) {
				...
				if ( $response->get_transarmor_token() ) {
					...
					$message = sprintf( __( 'First Data Payment Method Saved: %s ending in %s (expires %s)', WC_FirstData::TEXT_DOMAIN ),
					...
					if ( ! ( wc_firstdata()->is_subscriptions_active() && WC_Subscriptions_Order::order_contains_subscription( $order ) ) ) {
						...
						$order->add_order_note( __( 'Expected token not returned for transaction, verify Transarmor Token is properly configured in your First Data account.', WC_FirstData::TEXT_DOMAIN ) );
					}
				}
			...
			switch ( $response->get_transaction_type() ) {
				case self::TRANSACTION_TYPE_CHARGE:
					$message = sprintf( __( 'First Data Purchase Approved: %s ending in %s (expires %s)', WC_FirstData::TEXT_DOMAIN ), $response->get_card_type(), $card_last_four, $card_exp_date );
				break;
				case self::TRANSACTION_TYPE_AUTHORIZATION:
					$message = sprintf( __( 'First Data Pre-Authorization Approved: %s ending in %s (expires %s)', WC_FirstData::TEXT_DOMAIN ), $response->get_card_type(), $card_last_four, $card_exp_date );
				break;
	...
	protected function mark_order_as_failed( $order, $error_message, $user_error_message = null ) {
		...
		if ( is_null( $user_error_message ) ) {
			$user_error_message = __( 'An error occurred, please try again or try an alternate form of payment.', WC_FirstData::TEXT_DOMAIN );
		}

		$order_note = sprintf( __( 'First Data Payment Failed (%s)', WC_FirstData::TEXT_DOMAIN ), $error_message );
	...
	public function show_my_payment_methods() {
		...
		if ( ! empty( $_GET['wc-firstdata-token'] ) && ! empty( $_GET['wc-firstdata-action'] ) && ! empty( $_GET['_wpnonce'] ) ) {
			...
			if ( false === wp_verify_nonce( $_GET['_wpnonce'], 'wc-firstdata-token-action' ) )
				wp_die( __( 'There was an error with your request, please try again.', WC_FirstData::TEXT_DOMAIN ) );

			$token = trim( $_GET['wc-firstdata-token'] );

			if ( ! $token )
				wp_die( __( 'Token is invalid, please try again.', WC_FirstData::TEXT_DOMAIN ) );
