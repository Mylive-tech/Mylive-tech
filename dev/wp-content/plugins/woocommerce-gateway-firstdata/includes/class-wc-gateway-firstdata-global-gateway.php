...
class WC_Gateway_FirstData_Global_Gateway extends WC_Payment_Gateway {
	...
	public function __construct() {
		...
		$this->method_title       = __( 'First Data Global Gateway', WC_FirstData::TEXT_DOMAIN );
		$this->method_description = __( 'Allow customers to checkout with their credit cards through the First Data Global Gateway.', WC_FirstData::TEXT_DOMAIN );
	...
	public function init_form_fields() {
		...
		$this->form_fields = array(
			...
			'environment' => array(
				...
				'type'          => 'select',
				'default'       => 'production',
				'desc_tip'      => __( "Select your processing environment, use 'sandbox' only if you have a sandbox account for testing.", WC_FirstData::TEXT_DOMAIN ),
				'options'       => array(
					'production' => __( 'Production', WC_FirstData::TEXT_DOMAIN ),
					'sandbox'    => __( 'Sandbox', WC_FirstData::TEXT_DOMAIN ),
				),
			),

			'storenum' => array(
				'title'    => __( 'Store Number', WC_FirstData::TEXT_DOMAIN ),
				'type'     => 'text',
				'desc_tip' => __('Your First Data store number.', WC_FirstData::TEXT_DOMAIN ),
				'default'  => ''
			),

			'pemfile' => array(
				'title'       => __( 'PEM File', WC_FirstData::TEXT_DOMAIN ),
				'type'        => 'textarea',
				'description' => __( 'The full system path to your .PEM file from First Data, for security reasons you should store this outside of your web root. For your information your ABSPATH is: ', WC_FirstData::TEXT_DOMAIN ) . ABSPATH,
	...
	function payment_fields() {
		...
		<fieldset>
			<p class="form-row form-row-wide">
				<label for="firstdata-account-number"><?php _e( 'Credit Card Number', WC_FirstData::TEXT_DOMAIN ); ?> <span class="required">*</span></label>
			...
			<p class="form-row form-row-first">
				<label for="firstdata-exp-month"><?php _e( 'Expiration Date', WC_FirstData::TEXT_DOMAIN ); ?> <span class="required">*</span></label>
			...
			<p class="form-row form-row-last">
					<label for="firstdata-cvv"><?php _e( "Card Security Code", WC_FirstData::TEXT_DOMAIN ) ?> <span class="required">*</span></label>
	...
	public function process_payment( $order_id ) {
		...
		if ( 'APPROVED' == $result['r_approved'] ) {
			...
			$order->add_order_note( __( 'First Data Purchase Approved', WC_FirstData::TEXT_DOMAIN ) );
			...
			SV_WC_Helper::wc_add_notice( sprintf( __( 'Transaction Failed: %s', WC_FirstData::TEXT_DOMAIN ), $reason ), 'error' );
