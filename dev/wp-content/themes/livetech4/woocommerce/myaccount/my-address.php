...
<p class="myaccount_address">
	<?php echo apply_filters( 'woocommerce_my_account_my_address_description', __( 'By default the following addresses will be used on the checkout page.', 'woocommerce' ) ); ?> Preferred contact phone number: <strong><?php echo get_user_meta( $customer_id, 'billing_phone', true ) ?></strong>
</p>
