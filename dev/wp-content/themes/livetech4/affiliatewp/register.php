...
<form id="affwp-register-form" class="affwp-form" action="" method="post">
	...
	<fieldset>
		...
		<?php if ( ! is_user_logged_in() ) : ?>
			...
			<p>
				<label for="affwp-user-name"><?php _e( 'Your Full Name', 'affiliate-wp' ); ?></label>
			...
			<p>
				...
				<input id="affwp-user-email" class="required" type="email" name="affwp_user_email" value="<?php if( ! empty( $user_email ) ) { echo $user_email; } ?>" title="<?php esc_attr_e( 'Email Address - Username', 'affiliate-wp' ); ?>" />
			</p>
