...
<div id="support-center" style="float:right; margin-right:16px; margin-top:-139px;"> <a href="#" data-popup-target="#ltsupport-popup" title="Live-Tech Support Center">
...
#support-center{ background:url(../wp-content/themes/flatsome/chat-icon.png) no-repeat; height:84px}
.support-center-text > img{ width:178px;}
