...
<div id="top-link" class="support-center" style="float:right; margin-right:45px; margin-top:-139px;"> <a href="#" data-popup-target="#ltsupport-popup" title="Live-Tech Support Center">

  <div class="support-center-text" style="height:auto"> <img src="<?php bloginfo( 'template_url' ); ?>/new-cp/lt-support-center.png" width="139" /> <img src="<?php bloginfo( 'template_url' ); ?>/new-cp/lt-support-livechat.png" width="139" /> <img src="<?php bloginfo( 'template_url' ); ?>/new-cp/lt-support-start-remote-session.png" width="139" /> <img src="<?php bloginfo( 'template_url' ); ?>/new-cp/lt-support-submit-ticket.png" width="139"/> <img src="<?php bloginfo( 'template_url' ); ?>/new-cp/lt-support-suite.png" width="139" /> <img src="<?php bloginfo( 'template_url' ); ?>/new-cp/lt-support-knowledgebase.png" width="139"/> </div> </div>
...
#floating { margin-bottom:0px; margin-right:15px;}

#floating #top-link { background:url(/wp-content/themes/flatsome/chat-icon.png) no-repeat; height:80px; width:178px; margin-right:15px;float:right; border-radius:5px;}

.support-center-text { height:80px !important; margin-left:15px; width:145px;}

.support-center-text img { margin-top:13px;height:40px !important;}
