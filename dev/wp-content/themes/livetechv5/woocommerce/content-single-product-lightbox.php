...
<div class="large-7 columns">    
     ...
     <div class="product-image images">
                ...
                <div class="slide first">
                	...
                	<div class="lightboximg"><img itemprop="image" src="<?php echo $src_small[0]; ?>" alt="<?php echo $src_title; ?>" title="<?php echo $src_title; ?>" /></div>

                </div>

				

				<?php } else { echo '<div class="slide"><div class="lightboximg"><img src="'.wc_placeholder_img_src().'" title="'.get_the_title().'" alt="'.get_the_title().'"/></div></div>';} ?>
					...
					if ( $attachment_ids ) {
						...
						foreach ( $attachment_ids as $attachment_id ) {
							...
							<div class="slide">
            					...
            					<div class="lightboximg"><img src="<?php echo $image_small[0]; ?>" data-flickity-lazyload="<?php echo $image[0] ?>" alt="<?php echo $image_title ?>" title="<?php echo $image_title ?>" /></div>
