 ...
 * @extends  WC_Widget
 */
class LT_WC_Widget_Product_Categories extends WC_Widget {
	...
	public function __construct() {
		...
		$this->widget_id          = 'lt_woocommerce_product_categories';
		$this->widget_name        = __( 'Live Tech Product Categories', 'woocommerce' );
		$this->settings           = array(
			'title'  => array(
				'type'  => 'text',
			...
			'include'  => array(
				'type'  => 'text',
				'std'   => __( '', 'woocommerce' ),
				'label' => __( 'Include Categories IDs (priority over exclude)', 'woocommerce' )
			),
			'exclude'  => array(
				'type'  => 'text',
				'std'   => __( '', 'woocommerce' ),
				'label' => __( 'Exclude Category IDs', 'woocommerce' )
			),
			'dropdown' => array(
				'type'  => 'checkbox',
				'std'   => 0,
	...
	public function widget( $args, $instance ) {
		...
		$e             = isset( $instance['exclude'] ) ? $instance['exclude'] : false;
		$i             = isset( $instance['include'] ) ? $instance['include'] : false;
...
function action_widgets_init() {
	register_widget( 'LT_WC_Widget_Product_Categories' );
}
add_action( 'widgets_init', 'action_widgets_init', 50);