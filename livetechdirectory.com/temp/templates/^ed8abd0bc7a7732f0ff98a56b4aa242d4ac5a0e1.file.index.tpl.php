<?php /* Smarty version Smarty-3.1.12, created on 2015-11-25 00:32:59
         compiled from "/home/mylivete/public_html/livetechdirectory.com/templates/Core/DefaultFrontend/views/contact/index.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1216474857565501bb3342c3-63387485%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'ed8abd0bc7a7732f0ff98a56b4aa242d4ac5a0e1' => 
    array (
      0 => '/home/mylivete/public_html/livetechdirectory.com/templates/Core/DefaultFrontend/views/contact/index.tpl',
      1 => 1392375072,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1216474857565501bb3342c3-63387485',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_565501bb37d3f6_91405981',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_565501bb37d3f6_91405981')) {function content_565501bb37d3f6_91405981($_smarty_tpl) {?><?php if (@DISABLE_CONTACT_FORM==1){?>
...
' class="text" style="width: 60px; float: right;"/><br/><br/></div></div><?php }?><?php if (@VISUAL_CONFIRM==1){?><?php if ($_smarty_tpl->tpl_vars['dont_show_captch']->value!=1){?><div><div class="phpld-columnar phpld-equalize"><div class="phpld-label"><span class="phpld-required">*</span>Enter the code shown:</div><div class="phpld-fbox-text float-left"><input id="IMAGEHASH" name="IMAGEHASH" type="hidden" value="<?php echo $_smarty_tpl->tpl_vars['imagehash']->value;?>
