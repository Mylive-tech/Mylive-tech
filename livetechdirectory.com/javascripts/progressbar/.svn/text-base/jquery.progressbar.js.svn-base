	...
	$.extend({
		progressBar: new function() {
			...
			this.defaults = {
				...
				boxImage		: '../javascripts/progressbar/images/progressbar.gif',						// boxImage : image around the progress bar
				barImage		: {
									0:	'../javascripts/progressbar/images/progressbg_red.gif',
									30: '../javascripts/progressbar/images/progressbg_orange.gif',
									70: '../javascripts/progressbar/images/progressbg_green.gif'
								},
