...
$current_template_path = (defined ('MOBILE_TEMPLATE') && MOBILE_TEMPLATE != '' ? MOBILE_TEMPLATE : null);
...
if ($_REQUEST['action'] == 'activate')
{
   ...
   $url       = DOC_ROOT."/conf_mobile_templates.php?r=1";
...
$content = $tpl->fetch(ADMIN_TEMPLATE.'/conf_mobile_templates.tpl');
