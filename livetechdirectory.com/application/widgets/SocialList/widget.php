...
# ################################################################################
 */
class Widget_SocialList extends Phpld_Widget {
	function getContent() {
		$settings = $this->getFrontSettings();

		Phpld_View::addJavascript(DOC_ROOT."/javascripts/sociallist/jquery.socialist.js");
		Phpld_View::addStylesheet(DOC_ROOT."/javascripts/sociallist/jquery.socialist.css");
