...
class Widget_LatestListingsHeadlines extends Phpld_Widget_LinksList {
    ...
    function getContent() {
        ...
        $this->tpl->assign('LISTINGS', $this->getLinks());
