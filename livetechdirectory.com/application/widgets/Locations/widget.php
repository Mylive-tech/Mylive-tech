...
# ################################################################################
 */
class Widget_Locations extends Phpld_Widget {
    ...
    function getContent() {
        ...
        foreach ($locations as $location) {
            $locationsRes[$location['STATE']][$location['CITY']] = $location;
        }
        $this->tpl->assign("TITLE", $set['TITLE']);
        $this->tpl->assign('locations', $locationsRes);
