...
# ################################################################################
 */
class Widget_TagListings extends Phpld_Widget_LinksList {
    ...
    public function getLinks()
    {
        ...
        $tag = $tagModel->getTagByUri($_REQUEST['tag']);
        ...
        $links = $tag->getLinks($listingTypeWhere, $paginator->getOffset(), $paginator->getPerPage(), 'F');
