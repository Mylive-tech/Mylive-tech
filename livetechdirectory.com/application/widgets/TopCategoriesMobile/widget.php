...
/**
 ...
 # ################################################################################
 */
 class Widget_TopCategoriesMobile extends Phpld_Widget {
	...
	function getContent() {
        ...
        $topCategs = $db->GetAll($sql);
        $categsCollection = new Phpld_Model_Collection(Model_Category_Entity);
        $categsCollection->setElements($topCategs);

		$this->tpl->assign('topCategs', $categsCollection);
