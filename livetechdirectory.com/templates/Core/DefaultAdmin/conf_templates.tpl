...
<div class="block">
   ...
   {foreach from=$available_templates item=template key=key}
      ...
      <tr class="{$zebra}">
         ...
         <td class="smallDesc title"><a href="{$smarty.const.DOC_ROOT}/conf_templates.php?r=1&amp;action=activate&amp;template={$template.theme_path|escape|trim}" class="button activate"><span>{l}Activate{/l}</span></a></td>
      </tr>
      <tr class="{$zebra}">
         <td class="label">{l}Version{/l}:</td>
