...
{else}
   <div id="categtree">
      <h2>{l}Select category{/l} <span id="close_tree" onclick="{literal}catTreeClose(); return false;{/literal}" title="{l}Close category tree{/l}"><img src="{$smarty.const.TEMPLATE_ROOT}/images/arrow-up.png" alt="{l}Close category tree{/l}" width="12" height="12" border="0" /></span></h2>
