...
<li class="group">{include file="views/_shared/_placeholders/pagetitle.tpl" PAGETITLE="User Login" titleheading=$titleheading}</li>
<li>
<form method="post" action="" id="submit_form" class="phpld-form">
      <div class="formPage">
          ...
          <div class="forgot-pass-label">
                  <a href="{$smarty.const.DOC_ROOT}/user/register" title="{l}Register{/l}">{l}Register{/l}</a><br/>
